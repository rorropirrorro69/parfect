...
function acScene(k) {
  ...
  switch (k) {
    ...
    case 'stance': return wrap(`${sky}${grass}<line class="la-glow" x1="34" y1="76" x2="126" y2="68" stroke="#C7EE54" stroke-width="3" stroke-dasharray="6 5" stroke-linecap="round"/>${ball('', 78, 72)}<rect x="60" y="74" width="14" height="3" rx="1.5" fill="#2a3550"/><rect x="86" y="73" width="14" height="3" rx="1.5" fill="#2a3550"/>`);
    ...
    case 'distance': return wrap(`${sky}${grass}${flag(132, 70)}<line class="la-glow" x1="28" y1="74" x2="120" y2="70" stroke="#C7EE54" stroke-width="2.5" stroke-dasharray="5 5"/>${ball('', 28, 74)}`);
    case 'safe': return wrap(`${sky}<path d="M0 60 Q80 44 160 60 L160 90 L0 90 Z" fill="#79b94f"/><path class="la-glow" d="M30 80 Q80 64 120 70" fill="none" stroke="#C7EE54" stroke-width="3" stroke-dasharray="6 5" stroke-linecap="round"/>${flag(126, 68)}${ball('', 30, 80)}`);
    ...
    case 'trophy': return wrap(`${sky}${grass}<g class="la-bob"><path d="M64 26h32v10c0 9-7 16-16 16s-16-7-16-16z" fill="#f7d04a"/><rect x="76" y="52" width="8" height="9" fill="#c98a1e"/><rect x="66" y="61" width="28" height="5" rx="2" fill="#c98a1e"/></g><circle class="la-spark" cx="56" cy="24" r="2.6" fill="#C7EE54"/><circle class="la-spark2" cx="104" cy="22" r="2.2" fill="#3a7fd4"/>`);
