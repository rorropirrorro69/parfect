...
function vPlayerCard(u, agg) {
  ...
  if (agg) {
    ...
    const statIcon = {
      ...
      birdie: `<svg viewBox="0 0 24 24" aria-hidden="true"><g class="si-wings"><path d="M2 14 Q7 7.5 12 12.6" fill="none" stroke="#6db83f" stroke-width="2.6" stroke-linecap="round"/><path d="M22 14 Q17 7.5 12 12.6" fill="none" stroke="#6db83f" stroke-width="2.6" stroke-linecap="round"/></g><circle cx="12" cy="14.4" r="2.6" fill="url(#g3dLime)"/></svg>`,
