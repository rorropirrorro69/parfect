...
function vPlayerCard(u, agg) {
  ...
  if (agg) {
    ...
    const statIcon = {
      ...
      birdie: `<svg viewBox="0 0 24 24" aria-hidden="true"><ellipse cx="11" cy="18" rx="8.5" ry="3" fill="url(#g3dGrass)"/><ellipse cx="11" cy="17.6" rx="2.6" ry=".95" fill="#0c1a0a"/><path d="M16 17.5 V6" stroke="#2f3a16" stroke-width="1.6" stroke-linecap="round"/><path d="M16 6 L20.5 7.6 L16 9.2 Z" fill="#ff5a4d"/><circle class="si-drop" cx="11" cy="16" r="2.5" fill="url(#g3dBall)" stroke="#cdd6cf" stroke-width=".5"/></svg>`,
