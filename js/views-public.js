...
function vLanding() {
  ...
  // piezas vivas del campo (carrito + ardilla) reutilizables en landing y app
  const cartG = `<g class="lp-bcart-in"><ellipse cx="13" cy="18" rx="12" ry="2.4" fill="#1a3a14" opacity=".14"/><path d="M3 8 L6 2 L18 2 L21 8 Z" fill="#fff"/><rect x="5" y="3" width="11" height="5" rx="1" fill="#bfe6f7"/><rect x="2" y="8" width="20" height="7" rx="2" fill="#eef6df"/><rect x="20" y="9.5" width="6" height="5" rx="1.5" fill="#a7d36a"/><circle cx="7" cy="16" r="3" fill="#33382f"/><circle cx="17" cy="16" r="3" fill="#33382f"/><circle cx="7" cy="16" r="1.2" fill="#d6dccb"/><circle cx="17" cy="16" r="1.2" fill="#d6dccb"/></g>`;
  const sqG = `<g class="lp-sq-in"><ellipse cx="9" cy="18" rx="6" ry="1.8" fill="#1a3a14" opacity=".14"/><path class="lp-sq-tail" d="M11 13 q11 -1 8 -12 q-2 -6 -8 -3 q6 1 6 7 q0 6 -6 8 Z" fill="#b06a35"/><ellipse cx="9" cy="13" rx="5" ry="6.5" fill="#c87a40"/><circle cx="6" cy="6" r="3.6" fill="#c87a40"/><path d="M3.4 3 q-.6 -2.6 1.6 -2 q.4 1.6 -.5 2.9 Z" fill="#a85f2c"/><circle cx="4.9" cy="6" r="1" fill="#241308"/><ellipse cx="9" cy="14.5" rx="2.3" ry="3" fill="#e6c79a"/></g>`;
  const clubG = `<g class="lp-club" transform="translate(176 62)"><ellipse cx="24" cy="42" rx="29" ry="4" fill="#1a3a14" opacity=".12"/><rect x="3" y="20" width="42" height="22" rx="2" fill="#f4ecd6"/><path d="M-1 21 L24 5 L49 21 Z" fill="#c8623a"/><path d="M-1 21 L24 5 L49 21 Z" fill="#000" opacity=".05"/><rect x="19" y="30" width="10" height="12" rx="1" fill="#8a5a36"/><rect x="7" y="24" width="8" height="6" rx="1" fill="#bfe6f7"/><rect x="33" y="24" width="8" height="6" rx="1" fill="#bfe6f7"/><rect x="35" y="7" width="3" height="9" fill="#b06a40"/></g>`;
  const golferG = (x, y, cls) => `<g class="bgc-golfer ${cls}" transform="translate(${x} ${y}) scale(1.7)"><ellipse class="bgc-gsh" cx="0" cy="3" rx="7" ry="1.6"/><path class="bgc-gbody" d="M-2.6,2 L-1,-8 L1,-8 L2.6,2 Z"/><circle class="bgc-gbody" cx="0" cy="-11" r="2.6"/><line class="bgc-gclub" x1="1" y1="-8" x2="7" y2="-14"/><circle class="bgc-ball ${cls === 'gA' ? 'ballA' : 'ballB'}" cx="4" cy="-1" r="1.5"/></g>`;
  const liveG = `<g class="lp-sq s1" transform="translate(92 202)">${sqG}</g><g class="lp-sq s2" transform="translate(312 214)">${sqG}</g>${golferG(70, 214, 'gA')}${golferG(244, 220, 'gB')}${golferG(348, 208, 'gA')}`;
