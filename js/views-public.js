...
function vLanding() {
  ...
  const liveG = `${clubG}<g class="lp-sq s1" transform="translate(92 200)">${sqG}</g><g class="lp-sq s2" transform="translate(306 212)">${sqG}</g><g class="lp-bcart c1">${cartG}</g><g class="lp-bcart c2">${cartG}</g>`;
