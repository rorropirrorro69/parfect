...
const ASSETS = [
  ...
  './js/views-home.js?v=28',
  './js/views-round.js?v=28',
  './js/views-modules.js?v=28',
  './js/drills-library.js?v=28',
  './js/party.js?v=28',
  './js/views-party.js?v=28',
  './js/trophies.js?v=28',
  './js/views-trophies.js?v=28',
  './js/strategy.js?v=28',
  './js/sync.js?v=28',
  './js/app.js?v=28',
];
